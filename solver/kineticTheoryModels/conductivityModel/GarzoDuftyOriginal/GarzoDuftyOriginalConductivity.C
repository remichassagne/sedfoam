...
#include "GarzoDuftyOriginalConductivity.H"
...
namespace Foam
{
    defineTypeNameAndDebug(GarzoDuftyOriginalConductivity, 0);

    addToRunTimeSelectionTable
    (
        conductivityModel,
        GarzoDuftyOriginalConductivity,
        dictionary
    );
}
...
Foam::GarzoDuftyOriginalConductivity::GarzoDuftyOriginalConductivity(const dictionary& dict)
:
...
Foam::GarzoDuftyOriginalConductivity::~GarzoDuftyOriginalConductivity()
{}


// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //

Foam::tmp<Foam::volScalarField> Foam::GarzoDuftyOriginalConductivity::kappa
(
