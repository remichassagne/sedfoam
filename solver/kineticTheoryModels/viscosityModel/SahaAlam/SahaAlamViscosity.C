...
{
    defineTypeNameAndDebug(SahaAlamViscosity, 0);
    addToRunTimeSelectionTable(viscosityModel, SahaAlamViscosity, dictionary);
...
Foam::kineticTheoryModels::SahaAlamViscosity::SahaAlamViscosity
(
...
Foam::kineticTheoryModels::SahaAlamViscosity::mua
(
...
Foam::tmp<Foam::volScalarField>
Foam::kineticTheoryModels::SahaAlamViscosity::lambda
(
    const volScalarField& alpha,
    const volScalarField& Theta,
    const volScalarField& g0,
